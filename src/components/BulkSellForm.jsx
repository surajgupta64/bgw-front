...
export default function BulkSellForm({ open, handleClose }) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await fetch(
        "https://bgw-api.vercel.app/bulkSell/create",
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      ...
      >
        <DialogTitle id="scroll-dialog-title">Bulk Sell Form</DialogTitle>
